...
main.load = function() {
    ...
    try {
        ...
        domSplitter.innerHTML =
            '<br><br><br>' +
                '<button id="toForm" onclick="main.formatterToEditor();" title="JSON to Editor" class="convert"> <img src="'+STATIC_URL+'/img/treeRightTriangleBlack.png" style="width:8px; height:8px; margin-left:2px;"></button><br>' +
                '<br>' +
                '<button id="toJSON" onclick="main.editorToFormatter();" title="Editor to JSON" class="convert"><img src="'+STATIC_URL+'img/treeLeftTriangleBlack.png" style="width:8px; height:8px; margin-right:2px;"></button>';
